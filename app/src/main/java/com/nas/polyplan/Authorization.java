...
public class Authorization extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            startActivity(new Intent(Authorization.this, CreateFamily.class));
            finish();
        ...
        logIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isSigningUp) {
                    ...
                    signUP.setText(R.string.log_in);
                    logIn.setText(R.string.no_account);
                    ...
                    logIn.setText(R.string.already_have_an_account_log_in);
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email.getText().toString(), password.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    FirebaseDatabase.getInstance().getReference("user/" + FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(new User(username.getText().toString(), email.getText().toString(), "", FirebaseAuth.getInstance().getCurrentUser().getUid()));
                    startActivity(new Intent(Authorization.this, CreateFamily.class));
